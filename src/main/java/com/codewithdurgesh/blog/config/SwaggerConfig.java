...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Bloging Aplication : Backend Course", "This code is developed by learn code with durgesh ",
				"1.0", "Terms of service",
				new Contact("Chitresh", "chitreshkukreja94@gmail.com", "chitreshkukrej1234@gmail.com"),
